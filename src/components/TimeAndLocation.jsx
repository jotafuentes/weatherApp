...
export function TimeAndLocation ({ dataWeather }) {
  ...
  return (
        <div className=" flex flex-col justify-evenly items-center relative rounded-xl backdrop-blur-xl border border-black/10 shadow-inner shadow-white/10 lg:col-span-1 md:col-span-3  bg-gradient-to-b from-indigo-950 from-50% to-blue-800 to-100% ">
